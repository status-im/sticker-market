...
exports.Test = (ERC20Token) => {
    ...
    it("should transfer 1 token", async function() {
      ...
      assert.equal(result0, (+initialBalance0-1).toString(), "account 0 balance unexpected");
      assert.equal(result1, (+initialBalance1+1).toString(), "account 1 balance unexpected");
    });
    ...
    it("should consume allowance amount", async function() {
      ...
      assert.equal(result, (+initialAllowance-1).toString());
    });
    ...
    it("should transfer approved amount", async function() {
      ...
      assert.equal(result0, (+initialBalance0-1).toString());
      assert.equal(result1, (+initialBalance1+1).toString());
    });
